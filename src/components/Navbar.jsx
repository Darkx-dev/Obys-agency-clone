function Navbar() {
  return (
    <nav className="navbar fixed z-20 left-0 top-0 right-0 py-14 px-20">
      <div className="nav-start flex items-center gap-10">
        <div className="menu">
          ...
          >
            ...
            <rect y="5" width="2" height="2" fill="white"></rect>
            <rect width="2" height="2" fill="white"></rect>
            <rect x="5" y="10" width="2" height="2" fill="white"></rect>
            <rect x="5" y="5" width="2" height="2" fill="white"></rect>
            <rect x="5" width="2" height="2" fill="white"></rect>
            <rect x="10" y="10" width="2" height="2" fill="white"></rect>
            <rect x="10" y="5" width="2" height="2" fill="white"></rect>
            <rect x="10" width="2" height="2" fill="white"></rect>
          </svg>
        </div>
        <div className="logo">
          <svg
      ...
      <div className="nav-end flex justify-between">
        <div className="para relative">
          <p className="absolute leading-[1rem]">
            Obys—
            <br />
            Creative
            <br />
        ...
        <div className="nav-routes flex">
            <h4 className="route works px-5">Works</h4>
            <h4 className="route about px-5">About</h4>
            <h4 className="route contacts px-5">Contacts</h4>
        </div>
      </div>
    </nav>
  );
